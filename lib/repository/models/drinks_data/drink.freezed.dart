...
class _$_Drink implements _Drink {
  _$_Drink(
      ...
      this.strVideo,
      this.strCategory,
      @JsonKey(name: 'strIBA') this.strIba,
      this.strAlcoholic,
      this.strGlass,
      this.strInstructions,
      @JsonKey(name: 'strInstructionsES') this.strInstructionsEs,
      @JsonKey(name: 'strInstructionsDE') this.strInstructionsDe,
      @JsonKey(name: 'strInstructionsFR') this.strInstructionsFr,
      @JsonKey(name: 'strInstructionsIT') this.strInstructionsIt,
      @JsonKey(name: 'strInstructionsZH-HANS') this.strInstructionsZhHans,
      @JsonKey(name: 'strInstructionsZH-HANT') this.strInstructionsZhHant,
      this.strDrinkThumb,
      this.strIngredient1,
      this.strIngredient2,
      this.strIngredient3,
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$_Drink &&
            const DeepCollectionEquality().equals(other.idDrink, idDrink) &&
            const DeepCollectionEquality().equals(other.strDrink, strDrink) &&
            const DeepCollectionEquality()
                .equals(other.strDrinkAlternate, strDrinkAlternate) &&
            const DeepCollectionEquality().equals(other.strTags, strTags) &&
            const DeepCollectionEquality().equals(other.strVideo, strVideo) &&
            const DeepCollectionEquality()
            ...
            const DeepCollectionEquality().equals(other.strGlass, strGlass) &&
            const DeepCollectionEquality()
                .equals(other.strInstructions, strInstructions) &&
            const DeepCollectionEquality()
                .equals(other.strInstructionsEs, strInstructionsEs) &&
            const DeepCollectionEquality()
                .equals(other.strInstructionsDe, strInstructionsDe) &&
            const DeepCollectionEquality()
                .equals(other.strInstructionsFr, strInstructionsFr) &&
            const DeepCollectionEquality()
                .equals(other.strInstructionsIt, strInstructionsIt) &&
            const DeepCollectionEquality()
                .equals(other.strInstructionsZhHans, strInstructionsZhHans) &&
            const DeepCollectionEquality()
                .equals(other.strInstructionsZhHant, strInstructionsZhHant) &&
            const DeepCollectionEquality()
            ...
            const DeepCollectionEquality()
                .equals(other.strMeasure1, strMeasure1) &&
            const DeepCollectionEquality()
                .equals(other.strMeasure2, strMeasure2) &&
            const DeepCollectionEquality()
                .equals(other.strMeasure3, strMeasure3) &&
            const DeepCollectionEquality()
                .equals(other.strMeasure4, strMeasure4) &&
            const DeepCollectionEquality()
                .equals(other.strMeasure5, strMeasure5) &&
            const DeepCollectionEquality()
                .equals(other.strMeasure6, strMeasure6) &&
            const DeepCollectionEquality()
                .equals(other.strMeasure7, strMeasure7) &&
            const DeepCollectionEquality()
                .equals(other.strMeasure8, strMeasure8) &&
            const DeepCollectionEquality()
                .equals(other.strMeasure9, strMeasure9) &&
            const DeepCollectionEquality()
                .equals(other.strMeasure10, strMeasure10) &&
            const DeepCollectionEquality()
                .equals(other.strMeasure11, strMeasure11) &&
            const DeepCollectionEquality()
                .equals(other.strMeasure12, strMeasure12) &&
            const DeepCollectionEquality()
                .equals(other.strMeasure13, strMeasure13) &&
            const DeepCollectionEquality()
                .equals(other.strMeasure14, strMeasure14) &&
            const DeepCollectionEquality()
                .equals(other.strMeasure15, strMeasure15) &&
            const DeepCollectionEquality()
                .equals(other.strImageSource, strImageSource) &&
            const DeepCollectionEquality()
                .equals(other.strImageAttribution, strImageAttribution) &&
  ...
  int get hashCode => Object.hashAll([
        ...
        const DeepCollectionEquality().hash(strInstructionsEs),
        const DeepCollectionEquality().hash(strInstructionsDe),
        const DeepCollectionEquality().hash(strInstructionsFr),
        const DeepCollectionEquality().hash(strInstructionsIt),
        const DeepCollectionEquality().hash(strInstructionsZhHans),
        const DeepCollectionEquality().hash(strInstructionsZhHant),
        ...
        const DeepCollectionEquality().hash(strImageAttribution),
